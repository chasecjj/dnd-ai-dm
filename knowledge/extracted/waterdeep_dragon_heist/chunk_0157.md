...
keywords: ["advantage", "armor class", "as", "athletics", "attack", "blackstaff", "blackstafffrom", "cha", "challenge", "city", "common", "connected", "dagger", "dash", "disengage", "disposal", "dwarvish", "glorified", "gralhunds", "harper"]
---
...
ries mason's tools, smith's tools, and thieves' tools, and 
has proficiency with all three. 
GAME STATISTICS 
Thorvin is a shield dwarf commoner, with 
these changes: 
...
risma modifier. 
ACT IONS 
Mu/tiattack. The swashbuckler makes three attacks: one with a 
...
est-ranking member of the Zhentarim squad stationed 
...
out the city. 
GAME STATISTICS 
Urstul Floxin is an Illuskan human assassin, with 
these changes: 
