...
keywords: ["additionally", "affect", "affected", "an", "any", "at higher leveis", "being", "casting time", "charisma", "chest", "components", "concentration", "copper", "course", "duration", "each", "early", "extends", "for", "glyph"]
---
...
instructions,
but no more than once each day. A creature
...
the spelllasts
until it is ended by one of the spells
mentioned above.
GENTLE
REPOSE
...
determine
if you are telling the truth indicates that you
are being truthful.
...
approaching
within a certain distance of the glyph, or
manipulating
the object on which the glyph is inscribed.
