...
pages: "271-271"
section: "Project"
keywords: ["affected", "being", "bond", "casting time", "centered", "coming", "components", "concentration", "copy", "creatures", "died", "disadvantage", "doesn", "duration", "ears", "every", "for", "grants", "if", "ilusion\ncasting time"]
---
...
Range: 500 miles
Components:
V,S, M (a small replica of you made from
materiais worth at least 5 gp)
Duration: Concentration, up to 1 day
Vou create an illusory copy of yourself that lasts for
the duration. The copy can appear at any location
within range that you have seen before, regardless of
intervening obstacles. The illusion Iooks and sounds
like you but is intangible. Ir the illusion takes any
...
Vou can see through its eyes and hear through its
...
Range: Touch
Components:
V,S, M (holy water or powdered silver
...
creatures: aberrations, celestiais, elementals, fey,
fiends, and undead.
The protection grants several benefits. Creatures of
those types have disadvantage on attack rolls against
the targel. The target also can't be charmed, frightened,
or possessed by them. Ir the target is already charmed,
...
Duration:
I hour
Vou touch a creature. If it is poisoned, you neutralize the
poison, If more than one poison afllicts the target, you
...
Ali nonmagical food and drink within a 5-foot-radius
...
Range: Touch
Components:
V,S, M (a diamond worth at least 500 gp,
which the spell consumes)
Duration:
Instantaneous
Vou return a dead creature you touch to life, provided
that it has been dead no longer than 10 days. Ir the
creature's soul is both willing and at liberty to rejoin the
body, the creature returns to life with I hit poinl.
...
This spell closes ali mortal wounds, but it doesn't
...
takes a -4 penalty to ali attack rolls, saving throws, and
...
Range: 30 feet
Components:
V,S, M (pieces of eggshell from two
different kinds of creatures)
Duration:
I hour
Vouforge a telepathic link among up to eight willing
