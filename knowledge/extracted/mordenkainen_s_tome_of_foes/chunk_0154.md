...
keywords: ["action", "advantage", "any", "armor class", "attack", "being", "cavalry training", "charmed", "concentration", "creatures", "damage resistances", "darkvision", "dexterity", "disadvantage", "due", "duergar resilience", "early", "equipment", "erga", "for"]
---
...
attacks, it casts a spell, or its concentration is broken (as if con-
...
Reduce, or its concentration is broken (as if concentrating on 
a spell). Any equipment the duergar wears or carries is invisi-
ble with it. 
...
the duergar magically decreases in size, along with anything it 
is wearing or carrying. While reduced, the duergar is Tiny, re-
