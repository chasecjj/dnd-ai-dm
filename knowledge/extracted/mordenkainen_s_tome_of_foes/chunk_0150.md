...
pages: "185-185"
section: "Drow House C Aptain"
keywords: ["action", "advantage", "ally", "armor class", "as", "at", "attack", "battle command", "being", "breastplate", "cantrips", "cha", "charisma", "charmed", "clairvoyance", "con", "condition immunities", "constitution", "darkvision", "death lance"]
---
...
CHA 
13 {+ 1) 
Battle Command. As a bonus action, the drow targets one ally 
...
tack or to take the Dodge or Hide action. 
...
Charisma (spell save DC 13). He can innately cast the following 
...
~· 
A CTION S 
Multiattack. The drow makes three attacks: two with his scimi-
tar and one with his whip or his hand crossbow. 
Scimitar. Melee Weapon Attack: +8 to hit, reach 5 ft., one 
target. Hit: 7 {ld6 + 4) slashing damage plus 14 (4d6) poi-
son damage. 
Whip. Melee Weapon Attack: +8 to hit, reach 10 ft., one target. 
Hit: 6 {ld4 + 4) slashing damage. If the target is an ally, it has 
advantage on attack rolls until the end of its next turn. 
Hand Crossbow. Ranged Weapon Attack: +8 to hit, range 30/120 
ft., one target. Hit: 7 (l d6 + 4) piercing damage, and the 
...
REACTIONS 
Parry. The drow adds 3 to his AC against one melee attack that 
...
being charmed, and magic can't put the drow to sleep. 
Innate Spellcasting. The drow's innate spellcasting ability is 
Charisma (spell save DC 18). She can innately cast the follow· 
...
Spellcasting. The drow is a 12th·level spellcaster. Her spellcast-
ing ability is Wisdom (spell save DC 18, +10 to hit with spell 
...
Death Lance. Me/ee Weapon Attack: +10 to hit, reach 5 ft., one 
target. Hit: 8 (ld6 + 5) piercing damage plus 18 (4d8) necrotic 
damage. The target's hit point maximum is reduced by an 
amount equal to the necrotic damage it takes. This reduction 
lasts until the target finishes a long rest. The target dies if its 
