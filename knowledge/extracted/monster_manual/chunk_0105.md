...
pages: "135-135"
section: "Flame Skull"
keywords: ["advantage", "armor class", "attack", "blazing", "cantrip", "charmed", "condition immunities", "controls", "created", "damage immunities", "damage resistances", "dark", "darkvision", "dimly", "doesn", "echo", "eldritch rejuvenation", "erupt", "eternally bound", "fire ray"]
---
...
radius, or bright light in a 15-foot radius and dim light for 
an additional15 feet. It can switch between the options as 
~':f 
~ 
/A: ; 
/ ,I' 
...
spells called up from the dark recesses of its mem9ry. 
...
transformation. 
LegacyofLife. A flameskull only dimly recalls its 
...
components it can no longer employ. 
...
food, drink, or sleep. 
-. j 
Magic Resistance. The flameskull has advantage 0n saving 
throws against spells and other magical effects. 
Rejuvenation. If the flameskull is destroyed, it regair:~s all its hit , 
points in 1 hour unless holy water is sprinkled on its remains or 
~ dispe l magic or remove curse spell is cast on them. 
Spellcasting. The flameskull is a 5th-level spell caster. Its 
