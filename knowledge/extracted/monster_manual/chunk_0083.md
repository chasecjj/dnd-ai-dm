...
pages: "111-111"
section: "Ancient Copper Dragon"
keywords: ["acid breath", "action", "actions", "any", "armor class", "attack", "attacks", "bite", "breath weapons", "cha", "change shape", "charisma", "claw", "climb", "con", "constitution", "copper", "costs", "damage immunities", "darkvision"]
---
...
1 options below. Only one legendary action option can be used 
