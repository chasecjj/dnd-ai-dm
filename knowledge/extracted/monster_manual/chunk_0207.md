...
pages: "282-282"
section: "Androsphinx"
keywords: ["action", "actions", "armor class", "attack", "attacks", "cantrips", "cast", "charmed", "claw", "claw attack", "con", "condition immunities", "constitution", "costs", "damage immunities", "day", "different", "disadvantage", "each", "emits"]
---
...
Cast a Spell (Costs 3 Actions). The sphinx casts a spe ll from its 
list of prepared spells, using a spell slot as norma l. 
