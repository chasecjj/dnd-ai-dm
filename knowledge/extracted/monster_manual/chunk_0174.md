...
pages: "235-235"
section: "Nag As"
keywords: ["armor class", "attack", "attacks", "bestow", "bite", "breathing", "calm", "cantrips", "cha", "charmed", "clairvoyance", "common \nchallenge", "con", "condition immunities", "constitution", "damage immunities", "darkvision", "flame", "functioning", "hit"]
---
...
CHA 
18 (+4) 
Rejuvenation. If it dies, the naga returns to life in ld6 days and 
regains all its hit points. Only a wish spell can prevent this trait 
from functioning. 
Spellcasting. The naga is an 11th-level spellcaster. Its 
spellcasting ability is Wisdom (spell save DC 16, +8 to hit with 
spell attacks), and it needs only verbal components to cast its 
