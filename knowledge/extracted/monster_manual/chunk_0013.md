...
pages: "19-19"
section: "Solar"
keywords: ["action", "actions", "advantage", "angelic weapons", "armor class", "arrow", "at", "attack", "blinding gaze", "cha", "challenge", "charisma", "charmed", "condition immunities", "constitution", "costs", "damage immunities", "damage resistances", "day", "dexterity"]
---
...
When the solar hits with any weapon, the weapon deal s an 
...
(spell save DC 25). It can innately cast the foll owing spells, 
...
from any cu rse, disease, poison, blindness, or deafness. 
lEGENDARY ACTIONS 
