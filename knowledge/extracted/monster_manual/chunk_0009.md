...
pages: "14-14"
section: "Aboleth"
keywords: ["action", "actions", "after", "amphibious", "applied", "armor class", "attack", "attacks", "challenge", "charmed", "constitution", "costs", "darkvision", "day", "deep", "detect", "different", "drain", "enslave", "hit"]
---
...
CHA 
18 {+4) 
Mucous Cloud. While underwater, the aboleth is surrounded 
...
can be removed by any magic that cures disease. After 1 minlilte, 
...
disease can be removed only by heal or another di sease-curing 
...
the target can com municate telepathically with each other over 
any distance. 
