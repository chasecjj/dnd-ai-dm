...
keywords: ["advantage", "amphibious", "armor class", "attack", "attacks", "bite", "cantrips", "darkvision", "disadvantage", "ethereal plane", "flame", "hit", "hit points", "if", "it", "its", "languages", "languages undercommon \nchallenge", "level", "lightning"]
---
