...
pages: "133-133"
section: "Empyrean"
keywords: ["advantage", "after", "amounts", "an", "armor class", "as", "battleaxe", "being", "better", "bound", "characteristi", "common", "compound", "constant", "crooked", "darkvision", "demogorgon", "demons", "distant", "driven"]
---
...
ETTI~ ·, ~ 
!I 
An ettin is a fold, two-headed giant with the crude 
...
ettin is released from servitude. When the child is old 
...
of the twin-headed Prince of Demons. Driven to near 
...
them as distant cousins, and ore tribes often entice 
ettins to serve as guards, scouts, and marauders. An 
ettin isn't particularly loyal to its ore handlers, but the 
